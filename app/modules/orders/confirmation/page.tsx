...
import { CheckCircle, ShoppingBag, Home, ArrowLeft, Package, Clock, XCircle, AlertCircle } from "lucide-react";
...
export default function OrderConfirmationPage() {
  ...
  const fetchOrderData = async (orderId: string) => {
    try {
      ...
      // Menggunakan endpoint sesuai dokumentasi: /orders/{{order_id}}
            ...
            <div className="p-6 md:p-8">
              {orderData && (
                <>
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p className="font-bold text-gray-900 text-lg">{formatCurrency(orderData.final_amount)}</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <p className="text-sm text-gray-600">Status Pesanan</p>
                        <p className="font-bold capitalize text-gray-900">{orderData.order_status}</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <p className="text-sm text-gray-600">Metode Pembayaran</p>
                        <p className="font-bold capitalize text-gray-900">{orderData.payment_method?.replace('_', ' ')}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Items List */}
                  <div className="mb-8">
                    <h3 className="text-lg font-bold text-gray-900 mb-4">Items dalam Pesanan</h3>
              ...
              <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-6 mb-8">
                <h3 className="font-bold text-gray-900 mb-4">Apa Selanjutnya?</h3>
